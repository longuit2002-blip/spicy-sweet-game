      ...
      {open ? (
        <>
          ...
          <motion.aside
            ...
            className="fixed inset-x-0 bottom-0 z-50 flex max-h-[min(56vh,420px)] flex-col overflow-hidden rounded-t-[1.75rem] border border-border/25 bg-card/95 shadow-kawaii backdrop-blur-xl xl:hidden"
          >
