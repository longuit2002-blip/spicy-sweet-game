...
const enGame = {
  ...
  challenge: {
    ...
    axisIdentityLabel: 'Challenge holder',
    axisIdentityPickHint: 'Choose wrong suit or wrong number below.',
    axisIdentitySpectatorHint: 'They are picking whether the bluff was on suit or number.',
    axisIdentityLockHint: 'Their axis stays face-down until the lock ends.',
    axisChallengingStatus: 'Challenging',
    revealFlipChallengingLead: 'Challenging',
    skipClaimRace: 'Skip contest',
    skipClaimRaceDone: 'You passed',
    skipClaimRaceAria:
      'Skip contesting this claim. If everyone skips, the declaration stands and play continues.',
    passProgress: 'Passed: {{current}} / {{total}}',
    passConsensusLabel: 'Out of the challenge',
    raceSkipMicroHint:
      'Tap the bell to claim the challenge, or pass below if you will not contest.',
    declarerPassWatchHint: 'Others are choosing whether to challenge your play.',
  },
  result: {
    realCard: 'Real card',
  ...
  game: {
    ...
    video: {
      ...
      player: 'Player',
      waiting: 'Waiting...',
      liveHint: 'Mic and camera are opt-in. You can stay to watch even if both are off.',
      idleHint: 'Enable your mic or camera when you want to join the room call.',
      enableAudio: 'Enable microphone',
      disableAudio: 'Mute microphone',
      enableVideo: 'Enable camera',
      disableVideo: 'Turn camera off',
      leave: 'Leave call',
      errors: {
        alreadyActiveElsewhere: 'Voice or video is already active in another tab for this room.',
        botsNotSupported: 'Bots cannot join voice or video.',
        notInRoom: 'Join the room before enabling voice or video.',
        notJoined: 'Enable voice or video before sending media updates.',
          peerUnavailable: 'That player is no longer available for voice or video.',
          permissionDenied: 'Browser permission is required to use your camera or microphone.',
          microphonePermissionDenied: 'Browser permission is required to use your microphone.',
          cameraPermissionDenied: 'Browser permission is required to use your camera.',
          deviceNotFound: 'No compatible camera or microphone was found.',
          noMicrophone: 'No microphone was found.',
          noCamera: 'No camera was found.',
          deviceBusy: 'Your camera or microphone is busy in another app.',
          microphoneBusy: 'Your microphone is busy in another app.',
          cameraBusy: 'Your camera is busy in another app.',
          unsupportedConstraints: 'This device cannot satisfy the requested media quality.',
          deviceUnavailable: 'Camera or microphone is unavailable right now.',
          microphoneUnavailable: 'Microphone is unavailable right now.',
          cameraUnavailable: 'Camera is unavailable right now.',
          socketNotReady: 'The room connection is still recovering. Try again in a moment.',
        },
    },
  },
  room: {
  ...
  phase: {
    ...
    penaltyTitleBluffCaught: 'Bluff caught!',
    penaltyTitleTruth: 'Claim holds',
    penaltyTitleTimedOut: 'Challenge timed out',
    penaltyCaptionTakesPile: 'Takes the contested pile',
    penaltyCaptionDraws: 'Draws {{count}} cards',
    /** Compact outcome line inside each player card (replaces duplicate middle chips). */
    penaltyVisualPile: '{{count}} cards → won pile',
    penaltyVisualDraw: '+{{count}} from deck',
    penaltyPilePreviewCaption: 'Contested pile on the table',
    /** Role strip above each outcome card — distinguishes pile winner vs penalty draw. */
    penaltyRoleReceivesPile: 'Receives the pile',
    penaltyRolePenaltyDraw: 'Penalty draw',
    /** Short caption under the large pile count in the outcome band. */
    penaltyOutcomePileCaption: 'To won pile',
    /** Short caption under the large draw count in the outcome band. */
    penaltyOutcomeDrawCaption: 'From deck',
...
const viGame = {
  ...
  table: {
    ...
    rankCycleReset:
      'Hạng 10 vừa được công nhận — chuỗi bắt đầu lại. Giữ nguyên chất đã khóa, chỉ được tuyên bố hạng 1, 2 hoặc 3.',
    trophiesLeft: 'Chiến tích còn',
    trophyDuelRailAria: 'Chiến tích trên bàn — còn {{remaining}} trong tổng {{total}}.',
    trophySlotClaimed: 'Ô chiến tích — đã được nhận',
    trophyDuelRailSr: 'Còn {{remaining}} trên tổng {{total}} chiến tích.',
    roundPile: 'Xấp vòng',
  ...
  challenge: {
    ...
    declareRole: 'Người tuyên bố',
    holderRole: 'Người giữ quyền thách',
    pickHelpAria: 'Hướng dẫn đầy đủ',
    timeRemainingSr: 'Còn {{seconds}} giây',
    contextChipStats: '{{hand}} trên tay · {{score}} điểm · {{trophies}} chiến tích',
    ...
    axisIdentityLabel: 'Người giữ thách',
    axisIdentityPickHint: 'Chọn sai vị hoặc sai số ở hai ô bên dưới.',
    axisIdentitySpectatorHint: 'Họ đang chọn thách trên vị hay trên số so với tuyên bố.',
    axisIdentityLockHint: 'Trục họ chọn vẫn úp cho đến khi hết thời gian khóa.',
    axisChallengingStatus: 'Đang thách',
    revealFlipChallengingLead: 'Đang thách',
    skipClaimRace: 'Không thách',
    skipClaimRaceDone: 'Bạn đã bỏ qua',
    skipClaimRaceAria:
      'Không tranh quyền thách. Khi mọi người đều bỏ qua, tuyên bố được chấp nhận và chơi tiếp.',
    passProgress: 'Đã bỏ qua: {{current}} / {{total}}',
    passConsensusLabel: 'Không tranh quyền',
    raceSkipMicroHint:
      'Bấm chuông để giành quyền thách, hoặc bấm bên dưới nếu bạn không thách.',
    declarerPassWatchHint: 'Mọi người đang chọn có thách lượt chơi của bạn hay không.',
  },
  result: {
    realCard: 'Bài thật',
    ...
    declarerPenaltyBluffCaught:
      '{{player}} rút 2 lá (bị bắt bluff; có thể lấy thêm bài Tổng Wild từ dự trữ).',
    challengerPenalty: '{{player}} rút 2 lá (có thể lấy thêm bài Tổng Wild từ dự trữ).',
    wasTruth: 'NÓI THẬT!',
  ...
  seat: {
    ...
    upNext: 'Lượt tiếp',
    ariaSeat: '{{player}} — {{hand}} trên tay, {{score}} điểm, {{trophies}} chiến tích. {{role}}',
  },
  actionLog: {
    title: 'Nhật ký',
    expand: 'Mở',
  ...
  scoreboard: {
    ...
    wildCards: 'Lá Wild trong xấp: {{count}} × {{points}} điểm',
    trophyCards: 'Chiến tích trong xấp: {{count}} × {{points}} điểm',
    pileSubtotal: 'Cộng xấp: {{value}}',
    wildHandPenalty: 'Wild còn trên tay: {{count}} × −{{penalty}} điểm',
    total: 'Tổng: {{value}}',
  ...
  game: {
    ...
    video: {
      ...
      reconnecting: 'Đang kết nối lại cuộc gọi…',
      idle: 'Chưa tham gia',
      you: 'Bạn',
      player: 'Người chơi',
      waiting: 'Đang chờ...',
      liveHint: 'Mic và camera là tùy chọn. Bạn vẫn có thể xem ngay cả khi đang tắt cả hai.',
      idleHint: 'Bật mic hoặc camera khi bạn muốn tham gia cuộc gọi của phòng.',
      enableAudio: 'Bật mic',
      disableAudio: 'Tắt mic',
      enableVideo: 'Bật camera',
      disableVideo: 'Tắt camera',
      leave: 'Rời cuộc gọi',
      errors: {
        alreadyActiveElsewhere: 'Mic hoặc video đang hoạt động ở tab khác của phòng này.',
        botsNotSupported: 'Bot không thể tham gia thoại hoặc video.',
        notInRoom: 'Hãy vào phòng trước khi bật thoại hoặc video.',
        notJoined: 'Hãy bật thoại hoặc video trước khi gửi cập nhật media.',
          peerUnavailable: 'Người chơi đó không còn khả dụng cho thoại hoặc video.',
          permissionDenied: 'Trình duyệt cần quyền truy cập camera hoặc microphone của bạn.',
          microphonePermissionDenied: 'Trình duyệt cần quyền truy cập microphone của bạn.',
          cameraPermissionDenied: 'Trình duyệt cần quyền truy cập camera của bạn.',
          deviceNotFound: 'Không tìm thấy camera hoặc microphone phù hợp.',
          noMicrophone: 'Không tìm thấy microphone.',
          noCamera: 'Không tìm thấy camera.',
          deviceBusy: 'Camera hoặc microphone đang được ứng dụng khác sử dụng.',
          microphoneBusy: 'Microphone đang được ứng dụng khác sử dụng.',
          cameraBusy: 'Camera đang được ứng dụng khác sử dụng.',
          unsupportedConstraints: 'Thiết bị này không đáp ứng được chất lượng media đã yêu cầu.',
          deviceUnavailable: 'Camera hoặc microphone hiện không khả dụng.',
          microphoneUnavailable: 'Microphone hiện không khả dụng.',
          cameraUnavailable: 'Camera hiện không khả dụng.',
          socketNotReady: 'Kết nối phòng vẫn đang hồi phục. Hãy thử lại sau một lát.',
        },
    },
  },
  room: {
    ...
    exitWithArrow: '← {{label}}',
    opponents: 'Đối thủ',
    opponentsTurnCarousel: 'Đối thủ — thứ tự lượt chơi',
  ...
  phase: {
    ...
    penaltyTitleBluffCaught: 'Bắt bluff!',
    penaltyTitleTruth: 'Đúng tuyên bố',
    penaltyTitleTimedOut: 'Hết giờ thách',
    penaltyCaptionTakesPile: 'Lấy xấp tranh chấp',
    penaltyCaptionDraws: 'Rút {{count}} lá',
    penaltyVisualPile: '{{count}} lá → xấp ăn',
    penaltyVisualDraw: '+{{count}} lá từ bộ',
    penaltyPilePreviewCaption: 'Xấp tranh chấp trên bàn',
    penaltyRoleReceivesPile: 'Nhận xấp vòng',
    penaltyRolePenaltyDraw: 'Phạt rút bài',
    penaltyOutcomePileCaption: 'Vào xấp ăn',
    penaltyOutcomeDrawCaption: 'Từ bộ bài',
